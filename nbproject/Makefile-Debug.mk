...
${OBJECTDIR}/ArbolB.o: ArbolB.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArbolB.o ArbolB.c
...
${TESTDIR}/tests/PIlaU.o: tests/PIlaU.c 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/PIlaU.o tests/PIlaU.c
...
${OBJECTDIR}/ArbolB_nomain.o: ${OBJECTDIR}/ArbolB.o ArbolB.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArbolB_nomain.o ArbolB.c;\
	else  \
...
${OBJECTDIR}/Colas_nomain.o: ${OBJECTDIR}/Colas.o Colas.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Colas_nomain.o Colas.c;\
	else  \
...
${OBJECTDIR}/Pila_nomain.o: ${OBJECTDIR}/Pila.o Pila.c 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Pila_nomain.o Pila.c;\
	else  \
